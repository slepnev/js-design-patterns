// Наблюдатель - механизм подписки, позваляющий следит за данными
class AutoNews {
...
autoNews.setNews('Test news');
// Jack has been informed about: Test news
// Max has been informed about: Test news
